...
import com.example.shoppinglist2.db.Items;
import com.example.shoppinglist2.viewmodel.ShowItemListActivityViewModel;
...
public class ShowItemsListActivity extends AppCompatActivity implements ItemsListAdapter.HandleItemsClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(itemName)){
                    Toast.makeText(ShowItemsListActivity.this,"Ürün adı Ekleyin",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        initViewModel();
        initRecylerView();
        viewModel.getAllItemList(category_id);
